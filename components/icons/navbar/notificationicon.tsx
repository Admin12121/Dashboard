...
export const NotificationIcon = () => {
  return (
    <svg width="24px"  height="24px"  className="stroke-default-900" viewBox="0 0 24 24"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <title>Iconly/Light/Notification</title>
        <g id="Iconly/Light/Notification" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd" strokeLinecap="round" stroke-linejoin="round">
            <g id="Notification" transform="translate(3.500000, 2.000000)" className="stroke-default-900" stroke-width="1.5">

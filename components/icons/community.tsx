...
export const Community = ({ color = "white" }: Props) => {
  return (
    <svg width="45px"  height="45px"  viewBox="0 0 24 24"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g id="Iconly/Light/3-User" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="3-User" transform="translate(1.000000, 3.500000)"  className={`stroke-white`} stroke-width="1.5">
